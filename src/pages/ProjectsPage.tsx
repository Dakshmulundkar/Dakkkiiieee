...
export default function ProjectsPage() {
  ...
  return (
    <main className="relative bg-bg-primary text-text-primary min-h-screen">
      ...
      {/* View Toggle / Header */}
      <div className="fixed top-32 right-12 z-[100] flex items-center gap-4">
      ...
      <AnimatePresence mode="wait">
         {viewMode === 'editorial' ? (
            ...
            >
               <div className="pt-40 px-12 md:px-24">
            ...
            <motion.div 
               ...
               exit={{ opacity: 0, y: -20 }}
               className="pt-48 px-12 md:px-24 lg:px-40 pb-40"
            >
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {PROJECTS.map((project, index) => (
                     <motion.div 
                        ...
                        className="group relative aspect-[4/5] rounded-[32px] overflow-hidden border border-white/5 bg-bg-secondary cursor-pointer"
                        onClick={() => setViewMode('editorial')}
                     >
                        <div 
                        ...
                        <div className="absolute bottom-10 left-10 right-10">
                           ...
                           <h3 className="text-2xl font-bold text-white group-hover:text-sky-400 transition-colors" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{project.title}</h3>
                        </div>
                     </motion.div>
                  ))}
               </div>
